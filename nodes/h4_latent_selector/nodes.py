...
class H4_LatentSelector:
    ...
    def generate(self, base_model, aspect_ratio, batch_size, custom_width=1024, custom_height=1024):
        
        # Initial values from widgets
        width = custom_width
        height = custom_height
        
        # --- 1. Resolution Logic (If not Custom) ---
        # We only calculate if NOT choosing custom.
        if base_model != "Start From Custom" and aspect_ratio != "Custom Dimensions":
            ...
            # We are in CUSTOM mode. Use widget values and snap.
