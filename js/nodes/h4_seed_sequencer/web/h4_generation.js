...
app.registerExtension({
    ...
    async beforeRegisterNodeDef(nodeType, nodeData) {
        ...
        if (nodeData.name === "H4_AxisDriver") {
            ...
            nodeType.prototype.onNodeCreated = function () {
                if (orig) orig.apply(this, arguments);
                this.size = [540, 520]; // Reduced from 560, 580
                ...
                const installUi = () => {
                    ...
                    // Modern ComfyUI Fix: Handle case where inputEl is missing
                    const host = configW.inputEl || null;
                    if (host) host.style.display = "none";

                    const wrapper = host ? host.parentElement : (this.main_widget_el || null);
                    if (!wrapper) {
                        // If we can't find a wrapper, we might need to wait or use node container
                        requestAnimationFrame(installUi);
                        return;
                    }
                    ...
                    Object.assign(container.style, {
                        ...
                        width: "95%", boxSizing: "border-box", // Width adjustment
